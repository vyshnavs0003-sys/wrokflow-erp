...
class IsAttendanceOwnerOrHR(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if not hasattr(
            ...
            return False
        return (
            obj.attendance.employee
            == request.user.employee_profile
        )


class IsAttendanceOwnerHRManager(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if not hasattr(
            ...
            return False
        employee = obj.attendance.employee
        return (
            employee == request.user.employee_profile
            or employee.reporting_manager
            == request.user.employee_profile
        )